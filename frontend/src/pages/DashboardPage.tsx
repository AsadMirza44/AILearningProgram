    ...
    <div className="page">
      <section className="hero hero-premium">
        <div>
          ...
          <p>
            A modern tutor-led experience with concept explorers, activity studios,
        ...
        <div className="hero-panel hero-panel-premium">
          ...
          <p>
            {weeks.length} learning tracks configured. {activeCount} progress records currently
            tracked in the embedded SQLite database at <code>backend/data/app.db</code>.
          </p>
        </div>
      </section>
      ...
      <section className="section-header">
        ...
        <p>
          The curriculum moves from AI foundations into prompting, data thinking, Python basics,
          RAG and MCP, agent building blocks, and a final capstone showcase.
        </p>
      </section>
      ...
      {teacherWorkshops.length ? (
        <>
          <section className="section-header section-header-spaced">
            ...
            <p>
              A separate teacher-focused enablement section for practical classroom use,
              responsible AI habits, and ready-to-apply teaching workflows.
            </p>
          </section>
